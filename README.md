Goal: Clean two files containing data on rainfall. Split data into 'City' and 'Rainfall'. Convert Rainfall values into integers. Drop the original data column. 
